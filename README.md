...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/swagger-ui-bundle-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8512&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/swagger-ui-bundle-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `swagger-ui-bundle` can be installed with:

```
conda install swagger-ui-bundle
```

It is possible to list all of the versions of `swagger-ui-bundle` available on your platform with:
